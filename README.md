...
La lunghezza dei cammini in totale veniva presa sommando le dimensioni di tutte le liste appartenenti al TreeMap.
Le percentuali per ogni cammino venivano effettuate sulla base di questo ultimo dato. Esempio: coverage=dimensione lista*100/lunghezzaTotaleCammini
Due TreeSet servivano per contenere i cammini più lunghi e più corti a parimerito.
